...
@store2.employees.create(first_name: "Emma", last_name: "Giles", hourly_rate: 35)
@store2.employees.create(first_name: "Stu", last_name: "Gold", hourly_rate: 80)
@store2.employees.create(first_name: "Jake", last_name: "Vart", hourly_rate: 24)
...
@store5.employees.create(first_name: "Minesh", last_name: "Desai", hourly_rate: 40)
